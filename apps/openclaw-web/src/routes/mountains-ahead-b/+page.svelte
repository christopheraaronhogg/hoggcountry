...
<svelte:head>
  <title>Mountains Ahead Version B: Climb + Descent | Hogg Country</title>
  <meta
    name="description"
    content="A knee-aware candidate Appalachian Trail mountain guide from mile 1,850 to Katahdin, with climb and northbound descent shown together."
  />
  <meta name="robots" content="noindex, nofollow" />
  <link rel="canonical" href="https://hoggcountry.com/mountains-ahead-b" />
</svelte:head>

<div class="candidate-guide">
  <header class="guide-hero">
    <div class="candidate-strip">
      <strong>Version B candidate</strong>
      <span>Climb + descent · current guide has not been replaced</span>
      <a href="/mountains-ahead">View Version A</a>
    </div>
    ...
    <div class="hero-grid">
      <div class="hero-copy">
        ...
        <div class="hero-actions">
          <a class="pdf-link" href="/guides/hogg-country-at-mountains-mile-1850-to-katahdin-version-b.pdf">
      ...
      <div class="hero-brief" aria-label="Version B guide summary">
        <p>Final stretch</p>
  ...
  <section class="score-key" aria-labelledby="score-title">
    <div>
      <p class="eyebrow">How Version B scores terrain</p>
    ...
    <div class="formula" aria-label="Version B score formula">
  ...
  <section class="method-note" aria-labelledby="method-title">
    <div>
      <p class="eyebrow">Candidate methodology</p>
  ...
  <footer class="guide-sources">
    ...
    <p>Candidate compiled {guide.generatedAt}. Mountain miles remain anchor-calibrated; none are hand-entered.</p>
  </footer>
</div>
...
<style>
  ...
  .candidate-strip {
    ...
    color: #fff8ec;
    background: var(--down-dark);
    font-size: 0.72rem;
    letter-spacing: 0.04em;
  }
  .candidate-strip strong { text-transform: uppercase; letter-spacing: 0.1em; }
  .candidate-strip span { opacity: 0.84; }
  .candidate-strip a { margin-left: auto; color: #fff; font-weight: 900; }
  ...
  @media (max-width: 520px) {
    .candidate-strip a { width: 100%; margin-left: 0; }
