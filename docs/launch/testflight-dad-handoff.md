...
Generated at: 2026-06-29T06:43:11.953Z
...
- Dad target-build proof: `docs/launch/proof/ios-testflight-build-32-refresh-2026-06-29T06-42.md` (1.0 (32), IN_BETA_TESTING, checked 2026-06-29T06:42:33.677Z).
...
- Snapshot checkout SHA: `b2e7582d590750b160abd329f6bfebc7b6bcca4d`.
...
- Use now: install/update the latest Dad Pilot TestFlight target `1.0 (32)`.
- Latest-code target: `1.0 (32)` is recorded in Dad Pilot and meets `1.0 (>= 13)`.
...
- Simulator preflight evidence: Latest simulator/debug local preflight device-local-ai-20260629T061751Z is clean: 100/100 cases, complete tools/source evidence, app 1.0 (32), install=debug, model=gemma-4-E2B-it-litert-lm.
- Simulator full runs: 12; partial runs: 0.
- Boundary: simulator/debug local preflight drives iteration but does not replace final TestFlight/iPhone proof.
- Latest simulator Run 100: `device-local-ai-20260629T061751Z` (100/100 cases, tools complete 100/100, sources complete 100/100, answer scan clean with 0 flagged).
- Final-proof mismatch by design: device-local-ai-20260629T061751Z (install=debug, expected testflight).
...
- [x] Full-suite tool routing proof: 12 current full run(s) with all required tools hit and source evidence recorded
- [x] Simulator/debug local full-suite preflight: Latest simulator/debug local preflight device-local-ai-20260629T061751Z is clean: 100/100 cases, complete tools/source evidence, app 1.0 (32), install=debug, model=gemma-4-E2B-it-litert-lm
- [x] Dad Pilot has current suite-required TestFlight build: Target build is available for Dad: target 1.0 (32); suite requires 1.0 (>= 13); Dad Pilot records 1.0 (32); latest native upload suite 2026-06-28.5 (fnv1a32:741b2381); current suite 2026-06-28.5 (fnv1a32:741b2381)
- [ ] Full TestFlight/iPhone Eval Lab run imported: No current full suite-compatible TestFlight/iPhone run found; 12 full device-on-device-gemma run(s) failed final-proof context: device-local-ai-20260628T235310Z (install=debug, expected testflight); device-local-ai-20260629T001151Z (install=debug, expected testflight); device-local-ai-20260629T005630Z (install=debug, expected testflight)
...
1. Confirm the phone build path above. For the next suite run, install/update the latest Dad Pilot TestFlight target `1.0 (32)`.
...
- Native context: TestFlight iPhone install, app build satisfying `1.0 (>= 13)`; current Dad Pilot proof records `1.0 (32)`, while latest Xcode target is `1.0 (32)`.
