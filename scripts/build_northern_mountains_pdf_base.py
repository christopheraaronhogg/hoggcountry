#!/usr/bin/env python3
"""Shared ReportLab helpers from the original climb-focused mountain guide."""
...
OUTPUT_PATH = ROOT / "output/pdf/hogg-country-at-mountains-mile-1850-to-katahdin-climb-only-legacy.pdf"
PUBLIC_PATH = ROOT / "apps/openclaw-web/static/guides/hogg-country-at-mountains-mile-1850-to-katahdin-climb-only-legacy.pdf"
