...
export const DEFAULT_CONTEXT_PACK: ContextPack = {
	...
	guideExcerpts: [
		...
		},
		{
			...
			tags: ['loadout', 'gear', 'pack', 'safety', 'shakedown', 'battery', 'dry-clothes', 'mail-home', 'camp-shoes'],
