...
<div class="food-calculator" class:mounted>
  ...
  <div class="guide-links">
    <a href="/guide/14-food-and-resupply" class="guide-link chapter-link">
      <span class="link-icon">📚</span>
      <span class="link-text">Full Food & Resupply Guide</span>
      <span class="link-arrow">→</span>
    </a>
    <a href="/guide#14-food-and-resupply" class="guide-link field-guide-link">
      <span class="link-icon">📖</span>
