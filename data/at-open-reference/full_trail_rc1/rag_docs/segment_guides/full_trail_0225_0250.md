...
---
doc_id: full-trail-rc1-0225-0250
route_id: at-full-trail-rc1-open-2026
start_mile_nobo_global_est: 225
end_mile_nobo_global_est: 250
official_miles: false
states: NC/TN
region_ids: mvp1_springer_davenport, coverage_gap_davenport_damascus
last_generated: 2026-05-16
license_status: open_license_share_alike
confidence: low_due_to_regional_mvp_gap
---

# Segment 225-250 Generated NOBO Miles

Generated miles are not official ATC mileage.

## Identity
- States: NC/TN
- Regions: mvp1_springer_davenport, coverage_gap_davenport_damascus
- Source route: at-main-osm-2026-open

## Terrain And Difficulty
- Difficulty labels in this span: severe
- Rockiness V2.1 average: 5.96 (medium_model_with_100m_dem_osm_and_bounded_dem_metadata; low_due_to_regional_mvp_gap)
- Tread score average: 2.6
...
## Water Candidates
- Mapped water/fording candidates in span: 73
...
- Shelter candidates: 1
- Town/resupply candidates: 1
- Business/service details are candidates only unless license-reviewed and current.

## Camping / Permit Summary
- Jurisdictions from current rules index: none matched in static index
