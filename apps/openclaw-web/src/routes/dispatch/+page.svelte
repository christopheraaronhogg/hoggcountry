...
<svelte:head>
  <title>Ranger Radio Dispatch | Live Trail Tracking</title>
  <meta
    name="description"
    content="Live tracking dispatches from the Appalachian Trail. Follow the hiker's position in real-time via ranger station radio transmissions."
  />
</svelte:head>
