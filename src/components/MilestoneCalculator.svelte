<script>
  ...
  const sections = [
    ...
    { name: 'Southern NC', startMile: 79, endMile: 164, highlight: 'Long ridge walks', emoji: '🌲' },
    { name: 'Great Smokies', startMile: 164, endMile: 242, highlight: 'Clingmans Dome 6,643 ft', emoji: '⛰️' },
    { name: 'Northern NC/TN', startMile: 242, endMile: 471, highlight: 'Big balds, Damascus', emoji: '🌾' },
    { name: 'Southern Virginia', startMile: 471, endMile: 637, highlight: 'Grayson Highlands ponies', emoji: '🐴' },
    { name: 'Central Virginia', startMile: 637, endMile: 788, highlight: 'Longest state section', emoji: '🛤️' },
    { name: 'Shenandoah', startMile: 788, endMile: 972, highlight: 'Gentle grades, fast miles', emoji: '🦌' },
    { name: 'Northern Virginia', startMile: 972, endMile: 1026, highlight: 'The Roller Coaster', emoji: '🎢' },
    { name: 'Mid-Atlantic', startMile: 1026, endMile: 1298, highlight: 'Harpers Ferry, rocky PA', emoji: '🪨' },
    { name: 'NY-NJ Highlands', startMile: 1298, endMile: 1473, highlight: 'Quick states fall fast', emoji: '🗽' },
    { name: 'Southern New England', startMile: 1473, endMile: 1658, highlight: 'CT & MA rolling hills', emoji: '🍂' },
    { name: 'Vermont', startMile: 1658, endMile: 1755, highlight: 'Green Mountains, mud', emoji: '🌿' },
    { name: 'White Mountains', startMile: 1755, endMile: 1898, highlight: 'Hardest terrain on AT', emoji: '🏔️' },
    { name: 'Maine', startMile: 1898, endMile: 2198, highlight: 'Katahdin awaits!', emoji: '🎯' },
  ];
  ...
  const trailTowns = [
    ...
    { mile: 164, name: 'Fontana Dam', highlight: 'Gateway to the Smokies', emoji: '🏗️', services: resupplyServicesByTownName['Fontana Dam'] || [] },
    { mile: 275, name: 'Hot Springs', highlight: 'First trail town, hot springs!', emoji: '♨️', services: resupplyServicesByTownName['Hot Springs'] || [] },
    { mile: 471, name: 'Damascus', highlight: 'Trail Days, friendliest town', emoji: '🎉', services: resupplyServicesByTownName['Damascus'] || [] },
    { mile: 862, name: 'Waynesboro', highlight: 'Gateway to Shenandoah', emoji: '🏘️', services: resupplyServicesByTownName['Waynesboro'] || [] },
    { mile: 1026, name: 'Harpers Ferry', highlight: 'ATC HQ, psychological halfway', emoji: '🏛️', services: resupplyServicesByTownName['Harpers Ferry'] || [] },
    { mile: 2079, name: 'Monson', highlight: 'Last stop before the wilderness', emoji: '🏕️', services: resupplyServicesByTownName['Monson'] || [] },
  ];
  ...
  const landmarks = [
    ...
    { mile: 109, name: 'Franklin' },
    { mile: 164, name: 'Fontana Dam' },
    { mile: 208, name: 'Newfound Gap' },
    { mile: 242, name: 'Standing Bear Farm' },
    { mile: 275, name: 'Hot Springs' },
    { mile: 471, name: 'Damascus' },
    { mile: 637, name: 'Pearisburg' },
    { mile: 788, name: 'Glasgow' },
    { mile: 862, name: 'Waynesboro' },
    { mile: 972, name: 'Front Royal' },
    { mile: 1026, name: 'Harpers Ferry' },
    { mile: 1099, name: 'Halfway Point' },
    { mile: 1298, name: 'Delaware Water Gap' },
    { mile: 1410, name: 'Bear Mountain' },
    { mile: 1473, name: 'Kent' },
    { mile: 1658, name: 'Manchester Center' },
    { mile: 1755, name: 'Hanover' },
    { mile: 1898, name: 'Gorham' },
    { mile: 2079, name: 'Monson' },
...
<div class="milestone-calc" class:mounted>
  ...
  <div class="guide-links">
    <a href="/guide/02-trail-sections-and-milestones" class="guide-link chapter-link">
      <span class="link-icon">📚</span>
      <span class="link-text">Full Trail Sections Guide</span>
      <span class="link-arrow">→</span>
    </a>
    <a href="/guide#02-trail-sections-and-milestones" class="guide-link field-guide-link">
      <span class="link-icon">📖</span>
