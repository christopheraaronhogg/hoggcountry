...
| CURRENT_PROJECT_VERSION (build) | `15` | ✓ live in Dad Pilot TestFlight |
...
## What this means
- **iOS** project-file blockers are cleared for the privacy manifest, shared scheme, LiteRT-LM package wiring, Release signing, and TestFlight archive/upload lane. Build `15` is live in Dad Pilot through the public TestFlight link. Scout AI still needs model-download/runtime smoke proof and the full 100-question Eval Lab export on a real TestFlight iPhone before Dad-ready claims.
