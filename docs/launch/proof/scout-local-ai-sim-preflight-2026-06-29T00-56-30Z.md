...
npm run intake:scout-local-ai-device-run -- --run .scout-artifacts/scout-local-ai-runs/ios-sim-gemma-device-local-ai-20260629T005630Z.json --allow-partial
...
- `.scout-artifacts/scout-local-ai-runs/ios-sim-gemma-device-local-ai-20260629T005630Z.json`
- `.scout-artifacts/scout-local-ai-runs/ios-sim-gemma-device-local-ai-20260629T005630Z.scan.json`
- `data/scout-local-ai/device-runs/device-local-ai-20260629T005630Z.json`
- `data/scout-local-ai/answer-quality-scans/device-local-ai-20260629T005630Z.scan.json`
- `data/scout-local-ai/reviews/device-local-ai-20260629T005630Z.review.json`
- `data/scout-local-ai/review-packets/device-local-ai-20260629T005630Z.review.md`
...
Latest simulator/debug local preflight device-local-ai-20260629T005630Z is clean: 100/100 cases, complete tools/source evidence, app 1.0 (28), install=debug, model=gemma-4-E2B-it-litert-lm
